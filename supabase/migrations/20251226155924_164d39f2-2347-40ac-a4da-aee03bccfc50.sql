-- Drop and recreate questions_with_votes view with additional profile fields
...
LEFT JOIN discussion_votes v ON v.votable_id = q.id AND v.votable_type = 'question'
...
-- Drop and recreate answers_with_votes view with additional profile fields
...
LEFT JOIN discussion_votes v ON v.votable_id = a.id AND v.votable_type = 'answer'
